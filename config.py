"""
OKTAGON SAV v2.4 - Configuration centrale
...
class SecurityConfig:
    ...
    hash_salt: str = 'oktagon_sav_v24'
    anti_loop_window_hours: int = 48  # 1 auto-reply / 48h
    anti_spam_max_per_hour: int = 50  # Max 50 emails sortants / heure
    anti_spam_max_per_client_hour: int = 10  # Max 10 emails / client / heure
...
class AgentConfig:
    ...
    ebook_min_amount: float = 10.0  # EUR
